...
export class CampDefinitionComponent implements OnInit {
  ...
  //definition = new BaseMine(5, 5);

  constructor(private domSanitizer: DomSanitizer, private baseservice: BaseserviceService) { }
  definition;
  ngOnInit() {

    this.definition = this.baseservice.baseGrid();
  }
